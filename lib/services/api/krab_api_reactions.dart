...
extension KrabApiReactions on KrabApi {
  /// Add or remove the current user's emoji reaction on an image. Returns
  /// whether the reaction now exists or was removed.
  ...
  /// Per-emoji tally of an image's reactions, across every group the current
  /// user can see.
  ...
  /// Who reacted to an image, one entry per (user, emoji), for the reactors
  /// sheet.
