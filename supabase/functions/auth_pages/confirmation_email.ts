// The signup confirmation mail body.
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#111;padding:40px 0;">
    <tr>
        <td align="center">
            <table width="480" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border-radius:16px;overflow:hidden;max-width:480px;width:100%;">

                <!-- Header -->
                <tr>
                    <td align="center" style="padding:36px 32px 24px;">
                        <img src="https://raw.githubusercontent.com/zatomos/KRAB/main/logo/krab_logo.png" width="80" height="80" alt="KRAB" style="display:block;border-radius:16px;" />
                        <div style="font-size:28px;font-weight:900;letter-spacing:4px;color:#fff;margin-top:12px;">KRAB</div>
                    </td>
                </tr>
